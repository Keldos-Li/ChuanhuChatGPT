...
def reload_javascript():
    ...
    js += '<script async type="module" src="https://cdn.jsdelivr.net/npm/intro.js@7.2.0/intro.min.js"></script><link href="https://cdn.jsdelivr.net/npm/intro.js@7.2.0/minified/introjs.min.css" rel="stylesheet" />'
